    ...
    <section className="about__container">
      ...
      <ul className="about__list">
        ...
        <li className="about__text">
          ...
          personal watchlist—ready for you whenever you are. Simply remove the
          Saved movies once you've completed them.
        </li>
        <li className="about__text">
          ...
          done to keep your account secure.
        </li>
        <li className="about__text">
        ...
        <li className="about__text">
          <strong>Search Bar:</strong> Use the search bar to find movies and
          discover exactly what you’re looking for with ease.
        </li>
      </ul>
